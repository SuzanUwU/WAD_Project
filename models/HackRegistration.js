...
const hackRegistrationSchema = new mongoose.Schema({
  ...
  eventId: {type: mongoose.Schema.Types.ObjectId, ref: 'Event', default: null}, // placeholder — link when events integration is complete
  
  // Team leader (the user submitting the form)
  userId: {type: String, default: 'placeholder_user'}, // replace with req.session.userId when session is ready
